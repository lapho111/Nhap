        ...
        return new Promise((resolve, reject) => {
            ...
            xhr.onload = function() {
                if (xhr.status === 200) {
                    ...
                    let taskURL = '';
                    if (trafficName === 'link w88','w88') {
                        taskURL = `https://w88vt.com/`;  // https://88bet${result}/
                    } else if (trafficName === 'fun88') {
                        taskURL = `https://fun88kyc.com/`;
                    } else if (trafficName === 'go88 coinfra.io') {
                        taskURL = `https://coinfra.io/`;
